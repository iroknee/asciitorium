...
function parseArgs() {
  ...
  if (filteredArgs.length !== 3) {
    console.error(
      'Usage: node map-builder.js <width> <height> <directory-name> [--smooth]'
    );
    console.error(
      'Example: node map-builder.js 10 10 dungeon-level-1 --smooth'
    );
    console.error(
      'Maps will be saved to public/art/maps/<directory-name>/map.art'
    );
